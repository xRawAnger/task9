...
<body>
    <div id="app">
        ...
        <form action="{{ route('saveproducts') }}" method="POST" enctype="multipart/form-data">
            @csrf
            Name:
            <input type="input" class="form-control mt-2" name="name" id="itemName">
            product_id:
            <input type="input" class="form-control mt-2" name="product_id" id="productID">
            price:
            <input type="input" class="form-control mt-2" name="price" id="price">
            specifications:
            <textarea name="specifications" class="form-control mt-2" id="spec"></textarea>
            description:
